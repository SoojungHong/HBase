...
#----------------------------------------------
echo 'disable and drop table pea_account_overall_hbase'
...
#------------------------
echo 'create table pea_account_overall_hbase'
...
#---------------------------------------
echo 'scan pea_account_overall_hbase'
scan 'pea_account_overall_hbase'

#-----------------------
# get a row from table
#-----------------------
echo 'get pea_account_overall_hbase row1'
get 'pea_account_overall_hbase', '1'

#disable 'test'
echo 'enable table pea_account_overall_hbase'
